...
option_list <- list(
  make_option(c("-d", "--dataset"), type="character", default="ZECUSDT_15m",
              help="Dataset name (e.g., ZECUSDT_5m, ZECUSDT_15m, ZECUSDT_30m, ZECUSDT_1h) [default: %default]"),
  make_option(c("-e", "--initial_train_end"), type="character", default="2019-12",
              help="Initial training end month for ZEC [default: %default]"),
  make_option(c("-c", "--cores"), type="integer", default=32,
              help="Number of parallel cores [default: %default]"),
  make_option(c("-o", "--output_dir"), type="character",
              default="zec_walkforward",
...
cat('\n')
cat('════════════════════════════════════════════════════════════════════════════\n')
cat(sprintf('%s ZEC Expanding Window Walk-Forward Analysis\n', dataset_name))
cat('════════════════════════════════════════════════════════════════════════════\n\n')
cat(sprintf('数据集: %s\n', dataset_name))
...
sink(summary_file)
cat(sprintf('ZEC Expanding Window Walk-Forward Analysis\n'))
...
cat('🎉 ZEC Expanding Window Walk-Forward Analysis 完成!\n\n')
