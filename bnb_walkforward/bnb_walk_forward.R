...
option_list <- list(
  make_option(c("-d", "--dataset"), type="character", default="BNBUSDT_15m",
              help="Dataset name (e.g., BNBUSDT_3m, BNBUSDT_5m, BNBUSDT_15m, BNBUSDT_30m) [default: %default]"),
  make_option(c("-e", "--initial_train_end"), type="character", default="2020-12",
              help="Initial training end month for BNB [default: %default]"),
  make_option(c("-c", "--cores"), type="integer", default=32,
              help="Number of parallel cores [default: %default]"),
  make_option(c("-o", "--output_dir"), type="character",
              default="bnb_walkforward",
...
cat('\n')
cat('════════════════════════════════════════════════════════════════════════════\n')
cat(sprintf('%s BNB Expanding Window Walk-Forward Analysis\n', dataset_name))
cat('════════════════════════════════════════════════════════════════════════════\n\n')
cat(sprintf('数据集: %s\n', dataset_name))
...
sink(summary_file)
cat(sprintf('BNB Expanding Window Walk-Forward Analysis\n'))
...
cat('🎉 BNB Expanding Window Walk-Forward Analysis 完成!\n\n')
