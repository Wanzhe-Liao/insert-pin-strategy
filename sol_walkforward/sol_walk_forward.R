...
option_list <- list(
  make_option(c("-d", "--dataset"), type="character", default="SOLUSDT_5m",
              help="Dataset name (e.g., SOLUSDT_5m, SOLUSDT_15m) [default: %default]"),
  make_option(c("-e", "--initial_train_end"), type="character", default="2023-01",
              help="Initial training end month for SOL [default: %default]"),
  make_option(c("-c", "--cores"), type="integer", default=32,
              help="Number of parallel cores [default: %default]"),
  make_option(c("-o", "--output_dir"), type="character",
              default="sol_walkforward",
...
cat('\n')
cat('════════════════════════════════════════════════════════════════════════════\n')
cat(sprintf('%s SOL Expanding Window Walk-Forward Analysis\n', dataset_name))
cat('════════════════════════════════════════════════════════════════════════════\n\n')
cat(sprintf('数据集: %s\n', dataset_name))
...
sink(summary_file)
cat(sprintf('SOL Expanding Window Walk-Forward Analysis\n'))
...
cat('🎉 SOL Expanding Window Walk-Forward Analysis 完成!\n\n')
