...
option_list <- list(
  make_option(c("-d", "--dataset"), type="character", default="FETUSDT_15m",
              help="Dataset name (e.g., FETUSDT_15m, FETUSDT_30m, FETUSDT_1h) [default: %default]"),
  make_option(c("-e", "--initial_train_end"), type="character", default="2022-12",
              help="Initial training end month for FET [default: %default]"),
  make_option(c("-c", "--cores"), type="integer", default=32,
              help="Number of parallel cores [default: %default]"),
  make_option(c("-o", "--output_dir"), type="character",
              default="fet_walkforward",
...
cat('\n')
cat('════════════════════════════════════════════════════════════════════════════\n')
cat(sprintf('%s FET Expanding Window Walk-Forward Analysis\n', dataset_name))
cat('════════════════════════════════════════════════════════════════════════════\n\n')
cat(sprintf('数据集: %s\n', dataset_name))
...
sink(summary_file)
cat(sprintf('FET Expanding Window Walk-Forward Analysis\n'))
...
cat('🎉 FET Expanding Window Walk-Forward Analysis 完成!\n\n')
