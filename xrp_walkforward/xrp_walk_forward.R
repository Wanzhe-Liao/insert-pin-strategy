...
option_list <- list(
  make_option(c("-d", "--dataset"), type="character", default="XRPUSDT_5m",
              help="Dataset name (e.g., XRPUSDT_5m, XRPUSDT_15m) [default: %default]"),
  make_option(c("-e", "--initial_train_end"), type="character", default="2021-12",
              help="Initial training end month for XRP [default: %default]"),
  make_option(c("-c", "--cores"), type="integer", default=32,
              help="Number of parallel cores [default: %default]"),
  make_option(c("-o", "--output_dir"), type="character",
              default="xrp_walkforward",
...
cat('\n')
cat('════════════════════════════════════════════════════════════════════════════\n')
cat(sprintf('%s XRP Expanding Window Walk-Forward Analysis\n', dataset_name))
cat('════════════════════════════════════════════════════════════════════════════\n\n')
cat(sprintf('数据集: %s\n', dataset_name))
...
sink(summary_file)
cat(sprintf('XRP Expanding Window Walk-Forward Analysis\n'))
...
cat('🎉 XRP Expanding Window Walk-Forward Analysis 完成!\n\n')
